...
/*
    ...
    - The idea is to find some random matching and then run hopcroft. 
      We could repeat this process n times hoping that we will find correct cost x ;)
*/
...
void solveTest() {
    ...
    // We couldn't fid correct matching.. :C
    cout << -1 << endl;
}
